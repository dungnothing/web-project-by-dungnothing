  ...
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Yasuo_55.jpg',
      ...
      },
      {
        ...
        boardId: 'board-id-01',
        title: 'Empty Column',
        cardOrderIds: ['column-id-04-placehorlder-card'],
        cards: [
          { _id: 'column-id-04-placehorlder-card', boardId: 'board-id-01', columnId: 'column-id-04', FE_PlaceholderCard: true }
        ]
      }
    ]
  }
